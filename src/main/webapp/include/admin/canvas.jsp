        ...
        <div class="offcanvas-wrapper mb-5 scroll-pull">
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="<%=request.getContextPath() %>/resources/assets/media/stock-600x400/img-1.jpg" title="" alt="" />
                </a>
            </div>
            <!--end::Item-->
            <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="<%=request.getContextPath() %>/resources/assets/media/stock-600x400/img-2.jpg" title="" alt="" />
                </a>
            </div>
            <!--end::Item-->
            <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                <div class="d-flex flex-column mr-2">
                    ...
                    >Professional camera for edge cutting shots</span
                    >
                    <div class="d-flex align-items-center mt-2">
                <span class="font-weight-bold mr-1 text-dark-75 font-size-lg"
                >$ 150</span
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="<%=request.getContextPath() %>/resources/assets/media/stock-600x400/img-3.jpg" title="" alt="" />
                </a>
            </div>
            <!--end::Item-->
            <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="<%=request.getContextPath() %>/resources/assets/media/stock-600x400/img-4.jpg" title="" alt="" />
                </a>
            </div>
            <!--end::Item-->
            <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="<%=request.getContextPath() %>/resources/assets/media/stock-600x400/img-8.jpg" title="" alt="" />
                </a>
            </div>
            <!--end::Item-->
        </div>
            ...
            >
                ...
                <div class="mb-15">
                  ...
                  <span class="symbol-label">
                    <img
                            src="<%=request.getContextPath() %>/resources/assets/media/svg/misc/006-plurk.svg"
                  ...
                  <span class="symbol-label">
                    <img
                            src="<%=request.getContextPath() %>/resources/assets/media/svg/misc/015-telegram.svg"
                            class="h-50 align-self-center"
                            alt=""
                    />
                  </span>
                  ...
                  <span class="symbol-label">
                    <img
                            src="<%=request.getContextPath() %>/resources/assets/media/svg/misc/003-puzzle.svg"
                            class="h-50 align-self-center"
                            alt=""
                    />
                  </span>
                  ...
                  <span class="symbol-label">
                    <img
                            src="<%=request.getContextPath() %>/resources/assets/media/svg/misc/005-bebo.svg"
                            class="h-50 align-self-center"
                            alt=""
                    />
                  </span>
                  ...
                  <span class="symbol-label">
                    <img
                            src="<%=request.getContextPath() %>/resources/assets/media/svg/misc/014-kickstarter.svg"
                            class="h-50 align-self-center"
                            alt=""
                    />
                  </span>
                    ...
                    <a href="#" class="navi-item">
                        <div class="navi-link rounded">
                            <div class="symbol symbol-50 mr-3">
                                <div class="symbol-label">
                                    <i
                                            class="flaticon-paper-plane-1 text-success icon-lg"
                                    ></i>
                                </div>
                            </div>
                            <div class="navi-text">
                            ...
                            <div class="d-flex flex-column mb-5 align-items-start">
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-circle symbol-40 mr-3">
                                        <img alt="Pic" src="<%=request.getContextPath() %>/resources/assets/media/users/300_12.jpg" />
                                    </div>
                                    <div>
                                        <a
                                                href="#"
                            ...
                            <div class="d-flex flex-column mb-5 align-items-end">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-circle symbol-40 ml-3">
                                        <img alt="Pic" src="<%=request.getContextPath() %>/resources/assets/media/users/300_21.jpg" />
                                    </div>
                                </div>
                                <div
...
<%--<div id="kt_demo_panel" class="offcanvas offcanvas-right p-10">--%>
    ...
    <%--<div class="offcanvas-content">--%>
        ...
        <%--<div class="offcanvas-wrapper mb-5 scroll-pull">--%>
            ...
            <%--<div--%>
                    <%--class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active"--%>
            <%-->--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo1.png" alt="" class="w-100" />--%>
                <%--</div>--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo2.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="../../demo2/dist"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo3.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="../../demo3/dist"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo4.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="../../demo4/dist"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo5.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="../../demo5/dist"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo6.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="../../demo6/dist"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo7.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="../../demo7/dist"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo8.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="../../demo8/dist"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo9.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="../../demo9/dist"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo10.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="../../demo10/dist"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo11.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="../../demo11/dist"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo12.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="../../demo12/dist"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo13.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="../../demo13/dist"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo14.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="#"--%>
                            <%--class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90"--%>
                    <%-->Coming soon</a--%>
                    <%-->--%>
                <%--</div>--%>
            <%--</div>--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo15.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="#"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo16.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="#"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo17.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="#"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo18.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="#"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo19.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="#"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo20.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="#"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo21.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="#"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo22.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="#"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo23.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="#"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo24.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="#"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo25.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="#"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo26.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="#"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo27.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="#"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo28.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="#"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo29.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="#"--%>
            ...
            <%--<div class="overlay rounded-lg mb-8 offcanvas-demo">--%>
                <%--<div class="overlay-wrapper rounded-lg">--%>
                    <%--<img src="<%=request.getContextPath() %>/resources/assets/media/demos/demo30.png" alt="" class="w-100" />--%>
                <%--</div>--%>
                <%--<div class="overlay-layer">--%>
                    <%--<a--%>
                            <%--href="#"--%>
